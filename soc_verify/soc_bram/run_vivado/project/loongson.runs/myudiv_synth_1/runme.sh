...
HD_PWD='D:/CALab/cdp_ede_local/output/exp10/soc_verify/soc_bram/run_vivado/project/loongson.runs/myudiv_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log myudiv.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source myudiv.tcl
